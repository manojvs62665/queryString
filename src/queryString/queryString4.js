...
export default function App() {
    ...
    const [selectedBrand, setSelectedBrand] = useState(qs.parse(history.location.search.substr(1)).brand);
    const [selectedYear, setSelectedYear] = useState(qs.parse(history.location.search.substr(1)).year);
